...
const Header: React.FC = () => {
  return (
    <section
      ...
      style={{ backgroundImage: "url('https://creatioftu2.com/wp-content/uploads/2023/02/bg-1-2048x1152.png')" }}
    >
      ...
      <div className="flex justify-center h-full w-full">
        <div className="flex flex-col lg:flex-row max-w-screen-lg m-auto font-poppins text-white p-4 lg:p-0">
          <div className="w-full lg:w-2/5 flex flex-col justify-end uppercase">
            <p className="text-lg sm:text-xl lg:text-2xl xl:text-3xl mt-4 lg:mt-0">FinTech Club Initiatives</p>
