...
const EventDetailPage: React.FC = () => {
  return (
    <div className="w-100 h-auto">
      ...
      <img src="https://fintech-club-website.s3.ap-southeast-2.amazonaws.com/fintech-forum-2024.JPG" alt="event-img" className="mx-auto w-[80vw] h-auto rounded-2xl" />
      <p className="font-poppins text-base sm:text-lg md:text-xl lg:text-2xl text-justify mt-4 w-4/5 mx-auto font-light">
        ...
        perferendis! Lorem, ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, ut. Quos sunt expedita ut eum delectus
        ducimus doloribus officia repudiandae neque, dolor dolorum voluptatum, non ratione aliquam molestias! Possimus,
        perferendis! Lorem, ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, ut. Quos sunt expedita ut eum delectus
        ducimus doloribus officia repudiandae neque, dolor dolorum voluptatum, non ratione aliquam molestias! Possimus,
        perferendis! Lorem, ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, ut. Quos sunt expedita ut eum delectus
