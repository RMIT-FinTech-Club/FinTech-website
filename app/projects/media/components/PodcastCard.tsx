        ...
        <div className="h-100 w-100 flex flex-row justify-between">
          <div className="w-3/5">
            <div className="flex flex-row justify-between mb-1">
              <p className="leading-normal text-sm font-semibold text-white">EP <span>1</span></p>
              <p className="leading-normal text-sm font-semibold text-white">75 MINS</p>
            </div>
            <h1 className="leading-normal text-[19px] font-extrabold text-white">How FinTech promote sustainable finance?</h1>
          </div>
          <div className="h-[4/5] bg-white w-[2px] opacity-50"></div>
          <div className="w-1/4">
            <div className="">
              <p className="text-md leading-normal text-white font-semibold">By</p>
              <p className="text-md leading-normal font-extrabold text-white">Philip An</p>
            </div>
            <FaCirclePlay className="block m-auto mt-4 cursor-pointer" size={50} />
          </div>
        </div>
      </div>
    </div>
