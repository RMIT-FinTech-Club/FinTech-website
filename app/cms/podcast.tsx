				...
				<div className="grid grid-flow-row auto-rows-max gap-7">
					...
					<div className="row-span-2 p-3 rounded-lg border-dashed border border-zinc-300 flex-col justify-center items-center gap-3 inline-flex">
						...
						<div className="text-center">
							<span
								className={`text-orange-300 text-lg font-normal ${fontSans.style} tracking-wide`}
							>
								Click
							</span>
							<span
								className={`text-black text-lg font-normal ${fontSans.style} tracking-wide`}
							>
								{" "}
								to browse your computer or drag pdf file to this
								area{" "}
							</span>
						</div>
						<div
							className={`text-center text-zinc-300 text-lg font-normal ${fontSans.style} tracking-wide`}
						>
							(Max. File size: 25MB)
						</div>
					</div>
