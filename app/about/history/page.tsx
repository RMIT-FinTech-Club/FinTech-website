	...
	return (
		<>
			<div className="mx-auto w-[806px] px-[52px] bg-white bg-opacity-0 flex-col justify-center items-center gap-4">
				<div className="absolute md:w-[250px] md:left-[100px] w-[340px] top-[120px] left-[134px] h-[4px] bg-black flex items-center">
					<div className="w-6 h-6 bg-black rounded-full" />
				</div>
				<div className="absolute md:w-[250px] md:right-[100px] w-[340px] top-[120px] right-[134px] h-[4px] bg-black flex flex-row-reverse items-center">
					<div className="w-6 h-6 bg-black rounded-full" />
				</div>
			...
			<div className="mt-[93px] mb-[77px] w-[500px] h-[300px] mx-auto" ref={emblaRef}>
				<div className="flex justify-between items-center">
					{['2020', '2021', '2022', '2023', '2024'].map((year, index) => {
						return (
							<div key={year} className={`flex shrink-0 md:ml-[60px] ml-[90px] items-center rounded-full duration-1000 ease-out ${index === centerSlideIndex ? "md:w-[200px] md:h-[200px] w-64 h-64 bg-slate-700 " : "w-32 h-32 bg-amber-200 md:w-[120px] md:h-[120px]"} `} >
								<div
									className={`mx-auto font-semibold ${index === centerSlideIndex ? 'text-orange-300 md:text-4xl text-5xl ' : 'text-slate-700 md:text-3xl text-4xl'} ${fontSans.style}`}
								>
									{year}
								</div>
							</div>
			...
			<img
				alt=""
				className="absolute md:w-[400px] md:left-[-120px] md:top-[340px] left-[-200.15px] top-[257px] rotate-[58.03deg] rounded-[59px]"
				src="https://ik.imagekit.io/mbrrji2rk/Picture1.png?updatedAt=1713240956080"
			/>
			<img
				alt=""
				className="absolute md:w-[400px] md:right-[-120px] md:top-[340px] right-[-200.15px] top-[257px] rotate-[-58.03deg] rounded-[59px]"
				src="https://ik.imagekit.io/mbrrji2rk/Picture1.png?updatedAt=1713240956080"
			/>
			<img
				alt=""
				className="absolute md:bottom-[-330px] bottom-0 left-0 w-[330px] h-[306px] md:w-[250px] md:h-auto"
				src="https://ik.imagekit.io/mbrrji2rk/3164276f-e306-432f-ab36-b9a275439de7.jpg?updatedAt=1713241506012"
			/>
			<img
				alt=""
				className="absolute md:bottom-[-330px] md:w-[180px] bottom-0 w-[330px] h-[306px] md:w-[250px] md:h-auto right-0 rotate-[-24.12deg]"
				src="https://ik.imagekit.io/mbrrji2rk/3164276f-e306-432f-ab36-b9a275439de7.jpg?updatedAt=1713241506012"
			/>
			<div
