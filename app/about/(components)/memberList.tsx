...
const MemberList: React.FC<MemberListProps> = ({ members, itemsPerPage }) => {
	...
	return (
		<div className="flex flex-col justify-center items-center w-full">
			...
			<div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 flex sm:flex-col justify-center my-4 xl:gap-x-12 xl:gap-y-4 2xl:gap-x-16 2xl:gap-y-8 md: min-h-[400px] xl:min-h-[500px] 2xl:min-h-[600px]">
