  ...
  return (
    <>
      <div className="container mx-auto flex justify-center items-center h-auto ">
        <div className="inline-block md:w-1/4 flex items-center">
          <div className="md:w-3/4 h-1 bg-black flex items-center">
            <div className="md:w-6 md:h-6 bg-black rounded-full" />
          </div>
        </div>
        <div className="w-auto mx-1 md:w-2/3 flex-col justify-start items-center">
          <div
        ...
        <div className="inline-block md:w-1/4 flex justify-end items-center">
          <div className=" md:w-3/4 h-1 bg-black flex justify-end items-center">
            <div className="md:w-6 md:h-6 bg-black rounded-full" />
          </div>
        </div>
      </div>
      <div
        className={`w-auto mx-4 md:w-1/2 md:mx-auto my-4 text-black text-lg ${fontSans.style} tracking-wide text-center`}
      >
        {" "}
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras viverra
        viverra eros, eu euismod arcu dignissim quis. Phasellus sollicitudin
      </div>
      <div
      ...
      >
        <div className="flex justify-between items-center">
          {["2020", "2021", "2022", "2023", "2024"].map((year, index) => {
            return (
              <div
                key={year}
                className={`flex shrink-0 md:ml-[60px] items-center rounded-full duration-1000 ease-out select-none ${
        ...
        <img
          alt=""
          className="absolute md:w-[300px] md:right-[-120px] md:top-[340px] lg:right-[-190.15px] lg:w-[600px] top-[257px] rotate-[-58.03deg] rounded-[59px]"
          src="https://ik.imagekit.io/mbrrji2rk/Picture1.png?updatedAt=1713240956080"
        />{" "}
        <img
          alt=""
          className="md:absolute bottom-0 left-0 w-[330px] h-[306px] md:w-[250px] md:h-auto transform "
          src="https://ik.imagekit.io/mbrrji2rk/3164276f-e306-432f-ab36-b9a275439de7.jpg?updatedAt=1713241506012"
        />
        <img
          alt=""
          className="md:absolute bottom-0 right-0 w-[330px] h-[306px] md:w-[250px] md:h-auto transform -scale-x-100"
          src="https://ik.imagekit.io/mbrrji2rk/3164276f-e306-432f-ab36-b9a275439de7.jpg?updatedAt=1713241506012"
        /> */}
      </div>
      <div className="container flex-row gap-3 justify-end absolute w-1/4 top-[500px] left-0">
        <img
          alt=""
          className="hidden md:block md:w-[300px] md:left-[-120px] md:top-[340px] lg:left-[-190.15px] lg:w-[600px] top-[257px] rounded-[59px]"
          src="https://ik.imagekit.io/mbrrji2rk/Picture1.png?updatedAt=1713240956080"
        />
        <img
          alt=""
          className="md:block bottom-0 left-0 w-[330px] h-[306px] md:w-[250px] md:h-auto transform "
          src="https://ik.imagekit.io/mbrrji2rk/3164276f-e306-432f-ab36-b9a275439de7.jpg?updatedAt=1713241506012"
        />
      </div>
      <div className="container flex-row gap-3 justify-end absolute w-1/4 top-[500px] right-0">
        <img
          alt=""
          className="hidden md:block md:w-[300px] md:left-[-120px] md:top-[340px] lg:left-[-190.15px] lg:w-[600px] top-[257px] rounded-[59px]"
          src="https://ik.imagekit.io/mbrrji2rk/Picture1.png?updatedAt=1713240956080"
        ...
        <img
          alt=""
          className="md:block bottom-0 right-0 w-[330px] h-[306px] md:w-[250px] md:h-auto transform -scale-x-100"
          src="https://ik.imagekit.io/mbrrji2rk/3164276f-e306-432f-ab36-b9a275439de7.jpg?updatedAt=1713241506012"
        />
      </div>
      <div
        className={`w-auto mx-4 md:w-1/2 mb-[26px] md:mx-auto text-center text-slate-400 text-5xl font-bold ${fontSans.style}`}
      >
        Develop and Grow
      </div>
      <div
        className={`w-auto mx-4 md:w-1/2 mb-32 md:mx-auto text-justify text-black text-lg font-normal ${fontSans.style} tracking-wide`}
      >
