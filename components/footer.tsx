...
const Footer = () => {
	return (
		<footer className="md:h-fit w-full bg-ft-primary-blue flex flex-col justify-center z-50 items-center">
					...
					<div className="mt-[20px] flex flex-col-reverse items-center md:block">
						<div className="flex flex-col items-center md:block mb-[40px] md:mb-0 w-[90%] md:w-full">
							...
							<p className="text-ft-text-bright text-center md:text-left">
								...
								adipiscing elit. Ut ut bibendum lacus. Etiam
								eleifend nisl mi, vitae dignissim lectus
								elementum eu.{" "}
							</p>
						</div>
						<img
			...
			<div className="mx-auto my-[13px]">
				<p className="text-ft-text-bright text-center md:text-left w-[90%] md:w-full mx-auto">
					...
					designed and built by RMIT FinTech Club{" "}
				</p>
			</div>
		</footer>
	);
