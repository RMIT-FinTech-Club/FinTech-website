...
import { AnimationControls, TargetAndTransition, motion, type Variants } from 'framer-motion'
    ...
    return (
        <div className={clsx('relative w-screen h-screen')}>
            ...
            <motion.div
                ...
                >Welcome to FinTech</motion.h2>
                <br />

                <motion.p className='text-center w-full text-ft-text-bright' variants={textAppearVariants}>April 1st 2025, Report</motion.p>
