        ...
        <div className="flex flex-col w-[70%] mx-auto">
            ...
            <div className="mr-[8%] flex mb-5">
                ...
                <div className="w-1/2 flex items-center">
                    ...
                    <h5 className="ml-[5%] text-[100px] text-[#3B679F]"><span className="text-[#C1272D]">I</span>NNOVATIVE</h5>
                </div>               
            </div>
            <div className="ml-[22%] flex mb-5">
                <div className="w-1/2 flex flex-row-reverse items-center">
                    <div className="w-16 h-16 bg-white rounded-full absolute -left-8"></div>
                    <div className="w-16 h-16 bg-white rounded-full absolute -right-8"></div>
                    <h5 className="text-right mr-[5%] text-[100px] text-[#3B679F]">INCLUS<span className="text-[#C1272D]">I</span>VE</h5>
                </div>
                <div className="w-1/2">
            ...
            <div className="flex mb-5">
                ...
                <div className="w-1/3 flex justify-center items-center">
                    <div className="w-16 h-16 bg-white rounded-full absolute -left-8"></div>
                    <div className="w-16 h-16 bg-white rounded-full absolute -right-8"></div>
                    <h5 className="text-[100px] text-[#3B679F]">INSP<span className="text-[#C1272D]">I</span>RING</h5>
                </div>
                <div className="w-1/3">
